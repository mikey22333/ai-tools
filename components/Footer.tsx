...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200">      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Discover and explore cutting-edge AI tools across all industries. 
              Curated with care for creators, developers, and innovators.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/new-tools" className="text-gray-600 hover:text-primary-600 transition-colors">New Tools</Link></li>
              <li><Link href="/blog" className="text-gray-600 hover:text-primary-600 transition-colors">Blog</Link></li>
              <li><Link href="/submit-tool" className="text-gray-600 hover:text-primary-600 transition-colors">Submit Tool</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:riyassajeed233@gmail.com" className="text-gray-600 hover:text-primary-600 transition-colors text-sm">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-center">
          <p className="text-gray-600">
            © 2024 AllAiTools. All rights reserved. Made with ❤️ for the AI community.
          </p>
        </div>
      </div>
    </footer>
